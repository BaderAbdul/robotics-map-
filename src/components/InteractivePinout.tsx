...
// تعريف بيانات جميع الأقطاب الـ 32 للوحة Arduino Uno R3 - مطابقة حرفياً للصورة المرجعية
const pins = [
  // ========================================================
  // --- الصف العلوي (Top Edge) - Digital/PWM/I2C ---
  // ========================================================
  
  // البلوك العلوي الأيسر (10 أقطاب) - يُقرأ من اليسار (جهة الـ USB) لليمين
  ...
  { id: 'd13', name: '13', group: 'top_left', type: 'digital', icon: Hash, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج رقمي 13 (يحتوي على LED مدمج L).' },
  { id: 'd12', name: '12', group: 'top_left', type: 'digital', icon: Hash, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج/مدخل رقمي 12 (SPI MISO).' },
  { id: 'd11', name: '~11', group: 'top_left', type: 'digital', icon: Activity, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج رقمي 11 (PWM / SPI MOSI).' },
  { id: 'd10', name: '~10', group: 'top_left', type: 'digital', icon: Activity, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج رقمي 10 (PWM / SPI SS).' },
  { id: 'd9', name: '~9', group: 'top_left', type: 'digital', icon: Activity, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج رقمي 9 (PWM).' },
  { id: 'd8', name: '8', group: 'top_left', type: 'digital', icon: Hash, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج/مدخل رقمي 8.' },

  // البلوك العلوي الأيمن (8 أقطاب) - يُقرأ من اليسار لليمين
  { id: 'd7', name: '7', group: 'top_right', type: 'digital', icon: Hash, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج/مدخل رقمي 7.' },
  { id: 'd6', name: '~6', group: 'top_right', type: 'digital', icon: Activity, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج رقمي 6 (PWM).' },
  { id: 'd5', name: '~5', group: 'top_right', type: 'digital', icon: Activity, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج رقمي 5 (PWM).' },
  { id: 'd4', name: '4', group: 'top_right', type: 'digital', icon: Hash, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج/مدخل رقمي 4.' },
  { id: 'd3', name: '~3', group: 'top_right', type: 'digital', icon: Activity, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج رقمي 3 (PWM / يدعم المقاطعة INT1).' },
  { id: 'd2', name: '2', group: 'top_right', type: 'digital', icon: Hash, textClass: 'text-green-400', glow: 'shadow-[0_0_15px_#4ade80]', desc: 'مخرج/مدخل رقمي 2 (يدعم المقاطعة INT0).' },
  { id: 'tx', name: 'TX->1', group: 'top_right', type: 'com', icon: Cable, textClass: 'text-slate-300', glow: 'shadow-[0_0_15px_#cbd5e1]', desc: 'قطب الإرسال التسلسلي (Serial TX).' },
  { id: 'rx', name: 'RX<-0', group: 'top_right', type: 'com', icon: Cable, textClass: 'text-slate-300', glow: 'shadow-[0_0_15px_#cbd5e1]', desc: 'قطب الاستقبال التسلسلي (Serial RX).' },


  // ========================================================
  // --- الصف السفلي (Bottom Edge) - Power & Analog In ---
  // ========================================================
  
  // البلوك السفلي الأيسر - مقبس الطاقة (8 أقطاب) - يُقرأ من اليسار (جهة مقبس الطاقة) لليمين
  ...
  { id: 'ioref', name: 'IOREF', group: 'bottom_power', type: 'gnd', icon: Zap, textClass: 'text-slate-500', glow: 'shadow-[0_0_10px_#475569]', desc: 'مرجع الجهد للشيلد (IOREF).' },
  ...
  { id: 'vin', name: 'Vin', group: 'bottom_power', type: 'power', icon: Zap, textClass: 'text-red-400', glow: 'shadow-[0_0_15px_#f87171]', desc: 'مدخل طاقة ببطارية خارجية (7-12V).' },

  // البلوك السفلي الأيمن - مقبس التناظري (6 أقطاب) - يُقرأ من اليسار لليمين
  { id: 'a0', name: 'A0', group: 'bottom_analog', type: 'analog', icon: Activity, textClass: 'text-yellow-400', glow: 'shadow-[0_0_15px_#facc15]', desc: 'مدخل تناظري (Analog In) القناة 0.' },
...
export default function InteractivePinout() {
  ...
  // دالة المسمار (مع تحديد موقع النص ليكون دائماً "داخل" مساحة اللوحة الخضراء)
  const PinSocket = ({ pin, labelPosition }: { pin: any, labelPosition: 'above' | 'below' }) => {
    ...
    return (
      ...
      >
        {/* المسمار (مربع أسود صغير، متلاصق تماماً بـ gap-[1px] في الحاوية الأكبر) */}
        ...
        {/* النصوص تتجه لداخل اللوحة (فوق الأقطاب السفلية، وتحت الأقطاب العلوية) مطابقة للواقع */}
  ...
  return (
    <div className="flex flex-col items-center gap-6 py-2 overflow-hidden">
      ...
      {/* حاوية 3D مع Scale للحماية من ضغط الشاشات الصغيرة */}
      <div className="relative w-full h-[260px] flex items-center justify-center scale-[0.60] sm:scale-[0.85] md:scale-100 origin-center" style={{ perspective: '1200px' }}>
        ...
        >
          ...
          {/* مقبس الطاقة الأسود (في الأسفل الأيسر) */}
          ...
          {/* ======================================================== */}
          {/* --- ترتيب الأقطاب الجديد (التوزيع الفيزيائي الحقيقي 100%) --- */}
          {/* ======================================================== */}

          {/* الصف العلوي (Digital Edge) -> النصوص تكون للأسفل (below) لتكون داخل حدود اللوحة */}
          <div className="absolute top-2 left-12 right-6 flex justify-between items-start" style={{ transform: 'translateZ(8px)' }}>
            <div className="flex gap-4">
              {/* البلوك الأيسر (10 أقطاب من SCL إلى 8) */}
              ...
              {/* البلوك الأيمن (8 أقطاب من 7 إلى RX0) */}
              <div className="flex items-center gap-[1px] bg-black p-[2px] rounded-sm border border-white/5 shadow-md">
      ...
      {/* بطاقة الشرح الداكنة المطابقة لتصميم العِدة */}
          ...
          {activePinData ? (
            ...
            >
              <div className="flex-1 space-y-2">
                <h5 className="text-sm font-bold text-slate-300 prose prose-invert max-w-none">
                ...
                <p className="text-sm text-slate-200 leading-relaxed font-bold whitespace-pre-line prose prose-invert prose-sm max-w-none">
                  {activePinData.desc}
